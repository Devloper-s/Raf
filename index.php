...
<body>
   ...
   <?php include"nav-bar.php"?>
    ...
    $sql = "SELECT * FROM banner LIMIT 1"; // Get the first banner or you can modify this query to fetch the banner you need
    $result = $conn->query($sql);
    
    // Fetch data if available
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $bannerTitle = $row['title'];         // Title of the banner
        $bannerDescription = $row['description'];  // Description of the banner
        // You can also add other fields like 'image' if you want to dynamically load an image
        // $bannerImage = $row['image'];  
        // Assuming you have an 'image' field in the banner table
    } else {
        // Default values if no data is available
        $bannerTitle = "Modern Interior Design Studio";
        $bannerDescription = "Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit.";
        // $bannerImage = "images/couch.png";
         // Default image path if no image in the database
    }
?>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-7">
                    <div class="hero-img-wrap">
                        <!-- Dynamically load the image if available -->
    ...
    <div class="product-section">
        <div class="container">
            <div class="row">
                ...
                $sql="SELECT * FROM chairproduct LIMIT 3";
                $result=$conn->query($sql);
                if($result->num_rows>0)
                {
                    while($row=$result->fetch_assoc())
                    {
                        ...
                        <a class="product-item" href="cart.php">
                            <img src="<?php echo $row['image']; ?>" class="img-fluid product-thumbnail" />
            ...
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    ...
                    <div class="row my-5">
                        <?php 
                        include("connection.php");
                        $sql="SELECT * FROM subwhyussection";
                        $result=$conn->query($sql);
                        ...
                        if($result->num_rows>0)
                        {
                            while($row=$result->fetch_assoc())
                            {
                                ...
                                <div class="feature">
                                    <div class="icon">
                                        <img src="<?php echo $row['img']; ?>" alt="Image" class="imf-fluid" />
                                    </div>
